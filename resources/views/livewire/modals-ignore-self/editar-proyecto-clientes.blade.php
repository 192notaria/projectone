    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Editar registro</h5>
                ...
                <div class="row justify-content-center">
                    {{-- <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <select wire:model="servicio_id" class="form-select" disabled>
                    ...
                    {{-- <div class="col-lg-12">
                        <div class="form-group mb-3 autocomplete">
                            ...
                            <input type="text" class="form-control" wire:model='buscarAbogado' placeholder="Jorge Luis..." disabled>
