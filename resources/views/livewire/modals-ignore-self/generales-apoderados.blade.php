<div wire:ignore.self class="modal fade modal-generales-apoderados"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card style-6" href="javascript:void(0);">
                                                <a style="cursor: pointer;" wire:click='borrarTestigo({{$apoderado->id}})'>
                                                ...
                                                <div class="card-footer">
                                                    <div class="row">
                                                        <div class="col-12 mb-0 text-center">
                                                            <b>{{$apoderado->cliente->nombre}} {{$apoderado->cliente->apaterno}} {{$apoderado->cliente->amaterno}}</b>
            ...
            <div class="modal-footer">
                ...
                <button wire:click='guardarTestigos("apoderados")' type="button" class="btn btn-outline-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    window.addEventListener('abrir-modal-generales-apoderados', event => {
        $(".modal-generales-apoderados").modal("show")
    })

    window.addEventListener('cerrar-modal-generales-apoderados', event => {
        $(".modal-generales-apoderados").modal("hide")
