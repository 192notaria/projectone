<div wire:ignore.self class="modal fade modal-generales-varios"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                            ...
                            @if ($tipoGenerales == "")
                                @if (count($varios) == 0)
                                    <div class="col-lg-12 text-center">
                                        <span class="badge badge-warning" style="width: 100%">Sin registros</span>
                                    </div>
                                @endif
                            @else
                                <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 mt-3 text-end">
                                                        <button wire:click='registrarGenerales' @if ($identificacion_oficial == "") disabled @endif class="btn btn-success">Guardar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card style-6" href="javascript:void(0);">
                                                <a style="cursor: pointer;" wire:click='borrarTestigo({{$vario->id}})'>
                                                ...
                                                <div class="card-footer">
                                                    <div class="row">
                                                        <div class="col-12 mb-0 text-center">
                                                            <b>{{$vario->cliente->nombre}} {{$vario->cliente->apaterno}} {{$vario->cliente->amaterno}}</b>
            ...
            <div class="modal-footer">
                ...
                <button wire:click='guardarGeneralesVarios' type="button" class="btn btn-outline-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    window.addEventListener('abrir-modal-generales-varios', event => {
        $(".modal-generales-varios").modal("show")
    })
    window.addEventListener('cerrar-modal-generales-varios', event => {
        $(".modal-generales-varios").modal("hide")
