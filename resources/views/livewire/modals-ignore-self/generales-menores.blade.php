<div wire:ignore.self class="modal fade modal-generales-menores"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
                            ...
                            @if ($tipoGenerales == "")
                                @if (count($menores) == 0)
                                    <div class="col-lg-12 text-center">
                                        <span class="badge badge-warning" style="width: 100%">Sin menores asignados</span>
                                    </div>
                                @endif
                            @else
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card style-6" href="javascript:void(0);">
                                                <a style="cursor: pointer;" wire:click='borrarTestigo({{$menor->id}})'>
                                                ...
                                                <div class="card-footer">
                                                    <div class="row">
                                                        <div class="col-12 mb-0 text-center">
                                                            <b>{{$menor->cliente->nombre}} {{$menor->cliente->apaterno}} {{$menor->cliente->amaterno}}</b>
...
<script>
    window.addEventListener('abrir-modal-generales-menores', event => {
        $(".modal-generales-menores").modal("show")
    })
    window.addEventListener('cerrar-modal-generales-menores', event => {
        $(".modal-generales-menores").modal("hide")
