    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Código QR del proyecto</h5>
            ...
            <div class="modal-body">
                <div class="visible-print text-center">
                    ...
                    @if ($qrData)
                        <img style="width: 200px; height: 200px;" src="data:image/png;base64, {!! base64_encode(QrCode::size(400)->format('png')->merge('https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/BMW_logo_%28gray%29.svg/2048px-BMW_logo_%28gray%29.svg.png', .3, true)->size(100)->style('round')->generate($qrData)) !!} ">
                    @endif
                </div>
            </div>
