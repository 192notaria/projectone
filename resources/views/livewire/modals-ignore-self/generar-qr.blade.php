        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="visible-print text-center">
                    ...
                    <img style="width: 200px; height: 200px;" src="data:image/png;base64, {!! base64_encode(QrCode::size(400)->format('png')->size(100)->style('round')->generate({{$proyecto->servicio->nombre}})) !!} ">
                </div>
            </div>
