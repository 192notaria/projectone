<div wire:ignore.self class="modal fade modal-generales-con-docs"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button wire:click='closeModal' class="btn" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
                @if ($tipoGenerales != "")<button type="button" wire:click='registrarAsignacion' class="btn btn-outline-primary">Guardar</button>@endif
            </div>
        </div>
    </div>
</div>
...
<script>
    window.addEventListener('abrir-modal-generales-con-docs', event => {
        $(".modal-generales-con-docs").modal("show")
    })

    window.addEventListener('cerrar-modal-generales-con-docs', event => {
        $(".modal-generales-con-docs").modal("hide")
