                                    ...
                                    <div class="row">
                                        @if ($generales->acta_nacmiento)
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <embed src="{{url($generales->acta_nacmiento)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                        ...
                                        @if ($generales->acta_matrimonio)
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <embed src="{{url($generales->acta_matrimonio)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                        ...
                                        @if ($generales->curp)
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <embed src="{{url($generales->curp)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                        ...
                                        @if ($generales->rfc)
                                            <div class="col-lg-12 mt-3">
                                                <label for="">RFC</label>
                                                <embed src="{{url($generales->rfc)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                        ...
                                        @if ($generales->identificacion_oficial_con_foto)
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <embed src="{{url($generales->identificacion_oficial_con_foto)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                        ...
                                        @if ($generales->comprobante_domicilio)
                                            <div class="col-lg-12 mt-3">
                                                ...
                                                <embed src="{{url($generales->comprobante_domicilio)}}" style="width: 100%; height: 400px;" type="application/pdf">
                                            </div>
                                        @endif
                                    </div>
                                </div>
