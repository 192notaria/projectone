<div wire:ignore.self class="modal fade modal-editar-generales-varios"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
...
<script>
    window.addEventListener('abrir-modal-editar-generales-varios', event => {
        $(".modal-editar-generales-varios").modal("show")
    })
    window.addEventListener('cerrar-modal-editar-generales-varios', event => {
        $(".modal-editar-generales-varios").modal("hide")
