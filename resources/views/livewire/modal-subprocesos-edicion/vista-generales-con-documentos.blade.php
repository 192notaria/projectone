                    ...
                    <div class="row">
                        ...
                        @if ($generales_data->acta_nacmiento)
                            <div class="col-lg-12 mt-3">
                                ...
                                <embed src="{{url($generales_data->acta_nacmiento)}}" style="width: 100%; height: 400px;" type="application/pdf">
                            </div>
                        @endif
                        ...
                        @if ($generales_data->acta_matrimonio)
                            <div class="col-lg-12 mt-3">
                                ...
                                <embed src="{{url($generales_data->acta_matrimonio)}}" style="width: 100%; height: 400px;" type="application/pdf">
                            </div>
                        @endif
                        ...
                        @if ($generales_data->curp)
                            <div class="col-lg-12 mt-3">
                                ...
                                <embed src="{{url($generales_data->curp)}}" style="width: 100%; height: 400px;" type="application/pdf">
                            </div>
                        @endif
                        ...
                        @if ($generales_data->rfc)
                            <div class="col-lg-12 mt-3">
                                <label for="">RFC</label>
                                <embed src="{{url($generales_data->rfc)}}" style="width: 100%; height: 400px;" type="application/pdf">
                            </div>
                        @endif
                        ...
                        @if ($generales_data->identificacion_oficial_con_foto)
                            <div class="col-lg-12 mt-3">
                                ...
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" src="{{url($generales_data->identificacion_oficial_con_foto)}}" style="width: 100%; height: 400px;" frameborder="0"></iframe>
                                </div>
                            </div>
                        @endif
                        ...
                        @if ($generales_data->comprobante_domicilio)
                            <div class="col-lg-12 mt-3">
                                ...
                                <embed src="{{url($generales_data->comprobante_domicilio)}}" style="width: 100%; height: 400px;" type="application/pdf">
                            </div>
                        @endif
                    </div>
                @endif
