<div wire:ignore.self class="modal fade modal-editar-recibos-pago"  data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLiveLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-outline-danger" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
                <button wire:click='editarReciboPago' type="button" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    window.addEventListener('abrir-modal-editar-recibos-pago', event => {
        $(".modal-editar-recibos-pago").modal("show")
    })

    window.addEventListener('cerrar-modal-editar-recibos-pago', event => {
        $(".modal-editar-recibos-pago").modal("hide")
