        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($escritura_activa)
                    ...
                    <div class="d-flex justify-content-between">
                        <h4>Descuento:</h4>
                        <h4>${{number_format($escritura_activa['descuento'], 2) ?? ""}}</h4>
                    </div>
                    <div class="d-flex justify-content-between">
                        <h4>Cobrado:</h4>
                        @php
                            $cantidad_cobrada = 0;
                            if($escritura_activa){
                                foreach ($escritura_activa->pagos_recibidos as $recibido) {
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h3>
                            ${{number_format($costoTotal - $escritura_activa['descuento'] - $cantidad_cobrada, 2)}}
                        </h3>
                    </div>
                @endif
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table table-responsive table-striped">
                    ...
                    <tbody>
                        @if ($escritura_activa)
                            @foreach ($escritura_activa->costos_proyecto as $key => $costo)
                                <tr>
        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table table-responsive">
                    ...
                    <tbody>
                        @if ($escritura_activa)
                            @foreach ($escritura_activa->pagos_recibidos as $pago)
                                <tr>
                                    <td>
