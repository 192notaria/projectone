<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <h3>Clientes</h3>
            @can('crear-clientes')
                <button wire:loading.attr='disabled' wire:click='nuevo_cliente' type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
