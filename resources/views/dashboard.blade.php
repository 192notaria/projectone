...
@section('links-content')
    ...
    <link href="{{ url("v3/src/assets/css/light/dashboard/dash_1.css") }}" rel="stylesheet" type="text/css" />
    <link href="{{ url("v3/src/assets/css/dark/dashboard/dash_1.css") }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
            <div class="row justify-content-center layout-top-spacing">
                <div class="col-lg-1 mt-5 mb-4">
                ...
                <div class="col-lg-12 mt-4">
                    <div class="text-center justify-content-center">
                        ...
                        <p class="error-text">Gracias por visitar esta seccion.</p>
                        <p class="text">Por el momento esta seccion esta en mantenimiento, no es necesario dar aviso sobre esto. Pronto se actualizara automaticamente...</p>
                        <p class="text">Saludos!</p>
                            ...
                            <div class="meta-info">
                                ...
                                <div class="avatar--group">
                                    ...
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ url("v3/src/assets/img/profile-8.jpeg") }}"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ url("v3/src/assets/img/profile-12.jpeg") }}"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ url("v3/src/assets/img/profile-19.jpeg") }}"/>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-one">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ url("v3/src/assets/img/profile-19.jpeg") }}" alt="avatar">
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-two">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ url("v3/src/assets/img/g-8.png") }}" alt="avatar">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="card-bottom-section">
                                ...
                                <div class="img-group">
                                    <img src="{{ url("v3/src/assets/img/profile-19.jpeg") }}" alt="avatar">
                                    <img src="{{ url("v3/src/assets/img/profile-6.jpeg") }}" alt="avatar">
                                    <img src="{{ url("v3/src/assets/img/profile-8.jpeg") }}" alt="avatar">
                                    <img src="{{ url("v3/src/assets/img/profile-3.jpeg") }}" alt="avatar">
                                </div>
...
@section('scripts-content')
    ...
    <script src="{{ url("v3/src/assets/js/dashboard/dash_1.js") }}"></script>
@endsection
