<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{Route::currentRouteName() == "copias-certificadas" ? "active" : ""}} {{Route::currentRouteName() == "ratificaciones-proceso" ? "active" : ""}} {{Route::currentRouteName() == "poderes-proceso" ? "active" : ""}} {{Route::currentRouteName() == "actas-proceso" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-pendientes" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-proceso" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-apoyo" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-escrituras" ? "active" : ""}}">
                ...
                <ul class="collapse submenu list-unstyled" id="serviciosNav" data-bs-parent="#accordionExample">
                    @can("ver-proyectos")
                        <li class="{{Route::currentRouteName() == "actas-proceso" ? "active" : ""}}">
            ...
            <li class="menu {{Route::currentRouteName() == "escrituras-general" ? "active" : ""}} {{Route::currentRouteName() == "contabilidad.facturas" ? "active" : ""}} {{Route::currentRouteName() == "admin-cotizaciones" ? "active" : ""}}">
                ...
                <ul class="collapse submenu list-unstyled" id="finanzasNav" data-bs-parent="#accordionExample">
            ...
            <li class="menu {{Route::currentRouteName() == "catalogos-juzgados" ? "active" : ""}} {{Route::currentRouteName() == "catalogos-documentos_generales" ? "active" : ""}} {{Route::currentRouteName() == "admin-subprocesos" ? "active" : ""}} {{Route::currentRouteName() == "admin-procesos_servicios" ? "active" : ""}} {{Route::currentRouteName() == "admin-ocupaciones" ? "active" : ""}} {{Route::currentRouteName() == "admin-servicios" ? "active" : ""}} {{Route::currentRouteName() == "catalogos-paises" ? "active" : ""}} {{Route::currentRouteName() == "catalogos-estados" ? "active" : ""}} {{Route::currentRouteName() == "catalogos-municipios" ? "active" : ""}} {{Route::currentRouteName() == "catalogos-colonias" ? "active" : ""}}">
                ...
                <ul class="collapse submenu list-unstyled" id="catalogos" data-bs-parent="#accordionExample">
                    ...
                    @endcan
                    @can('ver-juzgados')
                        <li class="{{Route::currentRouteName() == "catalogos-juzgados" ? "active" : ""}}">
                            <a href="/catalogos/juzgados"> Juzgados </a>
                        </li>
                    @endcan
                    @can('ver-municipios')
