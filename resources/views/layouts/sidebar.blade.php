<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{Route::currentRouteName() == "poderes-proceso" ? "active" : ""}} {{Route::currentRouteName() == "actas-proceso" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-pendientes" ? "active" : ""}} {{Route::currentRouteName() == "admin-cotizaciones" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-general" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-proceso" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-apoyo" ? "active" : ""}} {{Route::currentRouteName() == "escrituras-escrituras" ? "active" : ""}}">
