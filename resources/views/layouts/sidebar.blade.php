<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{activeRoute(route('admin-clientes'))}} {{activeRoute(route('lista-contactos'))}}">
            ...
            <li class="menu {{activeRoute(route('escrituras-proceso'))}} {{activeRoute(route('escrituras-apoyo'))}}">
